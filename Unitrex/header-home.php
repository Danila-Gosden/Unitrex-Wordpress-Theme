...
<div class="header_home">
    ...
    <div id="menu" class="header_home_menu">
    ...
    <h2 class="header_home_title"><?php
        echo get_theme_mod('home_header_title'); ?></h2>
    <p class="header_home_text"><?php
        echo get_theme_mod('home_header_text'); ?></p>
</div>